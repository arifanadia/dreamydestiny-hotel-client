        ...
        <div className=" h-[600px] bg-no-repeat bg-cover bg-center "
            ...
            <div className=" text-center mx-auto lg:text-left lg:pl-20 py-32 ">
                ...
                <div className="flex gap-6 justify-center lg:justify-start">
                    <Link to='/register'>
                        <Button className="bg-primaryColor lg:mx-0 mt-8 text-2xl shadow-xl">Register Now</Button>
                    </Link>
                    <Button className="bg-primaryColor  lg:mx-0 mt-8 text-2xl shadow-xl">Enquire Now</Button>
                </div>
            </div>
